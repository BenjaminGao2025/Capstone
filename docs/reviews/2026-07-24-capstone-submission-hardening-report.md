...
| P1-6 | Missing CI | No GitHub Actions workflow | **CONFIRMED** | No `.github/` directory existed. | P1 | Created `.github/workflows/submission-integrity.yml` with non-GPU checks. | None |
...
| scripts/audit_submission_results.py | New | Automated submission audit | None — new file | 49/49 tests pass, exit code 0 on manifest |
...
| tests/test_submission_audit.py | New | Audit unit tests | None | 49/49 pass |
...
| Test | Command | Exit Code | Key Output | UTC Time |
|------|---------|-----------|-----------|----------|
| Bash syntax: run_fcfs.sh | `bash -n scripts/run_fcfs.sh` | 0 | (no output) | 2026-07-24T15:36:44Z |
| Bash syntax: run_ltr.sh | `bash -n scripts/run_ltr.sh` | 0 | (no output) | 2026-07-24T15:36:44Z |
| Bash syntax: run_ltr_aging.sh | `bash -n scripts/run_ltr_aging.sh` | 0 | (no output) | 2026-07-24T15:36:44Z |
| Bash syntax: run_one_experiment_safe.sh | `bash -n scripts/run_one_experiment_safe.sh` | 0 | (no output) | 2026-07-24T15:36:44Z |
| Bash syntax: run_part2.sh | `bash -n scripts/run_part2.sh` | 0 | (no output) | 2026-07-24T15:36:44Z |
| Python compile | `python3 -m compileall scripts/ -q` | 0 | (no output) | 2026-07-24T15:36:44Z |
| Unit tests | `python3 -m unittest discover -s tests -v` | 0 | `Ran 49 tests in 1.34s OK` | 2026-07-24T14:43:00Z |
| Submission audit | `python3 scripts/audit_submission_results.py ...` | 0 | All 42 experiments pass | 2026-07-24T14:43:00Z |
| Figure lock | `git diff --exit-code -- figures/figure_inputs.json` | 0 | Clean diff | 2026-07-24T14:43:00Z |
...
This report was generated during the hardening process on branch `antigravity/capstone-submission-hardening-20260724`. Please refer to the PR body (GitHub PR #30) for the absolute latest CI run status and dynamically updated commit SHAs.
